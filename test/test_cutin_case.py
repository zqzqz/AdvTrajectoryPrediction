...
trace_length = 18
with open("trace18/115.json", 'r') as f:
    input_data = json.load(f)
av_trace = np.array(input_data["objects"]["1"]["observe_full_trace"])
pov_trace = np.array(input_data["objects"]["4"]["observe_full_trace"])
