...
class SpectralCowsDataLoader:
    def __init__(self, batch_size=1, obs_length=5, pred_length=20):
        ...
        self.test_data_dirs = os.path.join(self.root_dir, "../data/apolloscape/prediction_test/")

    def generate_data(self):
        for filename in os.listdir(self.test_data_dirs):
            file_path = os.path.join(self.test_data_dirs, filename)
